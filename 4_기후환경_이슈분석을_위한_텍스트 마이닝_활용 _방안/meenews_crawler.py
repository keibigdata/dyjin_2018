...
# Me E-news crawler by Daeyong Jin
...
class MeEnewsCrawler :
        ...
        def indexing(self, start_date=None, end_date=None, append=True):
            ...
            params = {'maxIndexPages': 1000, 'boardMasterId': 108, 'menuId': 284, 'condition.fromDate' : str(start_date) , 'condition.toDate' : str(end_date) }
            ...
            if(len(page_url_list) == 0) :
                page_url_list.append("http://www.me.go.kr/home/web/index.do?menuId=284")
            ...
            for page_url in page_url_list:
                ...
                for d in soup.select('table > tbody > tr > td:nth-of-type(3)'):
        ...
        def crawling_enews(self):
            ...
            for i in range(len(url_list)):
                ...
                date = soup.select('.view_info01  dl > dd')[0].text.strip()
                content = soup.select('div.view_con')[0].text.strip()
